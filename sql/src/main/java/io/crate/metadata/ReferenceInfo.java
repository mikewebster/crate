...
public class ReferenceInfo implements Streamable {
    ...
    public ReferenceInfo(ReferenceIdent ident,
                         ...
                         DataType type) {
        this(ident, granularity, type, ColumnPolicy.DYNAMIC, IndexType.NOT_ANALYZED, false);
    }
    ...
    public ReferenceInfo getRelocated(ReferenceIdent newIdent){
        return new ReferenceInfo(newIdent, granularity, type, columnPolicy, indexType, isNotNull);
    }
    ...
    public int hashCode() {
        ...
        return 31 * result + (isNotNull ? 1 : 0);
    }
    ...
    public String toString() {
        ...
        helper.add("isNotNull", isNotNull);
