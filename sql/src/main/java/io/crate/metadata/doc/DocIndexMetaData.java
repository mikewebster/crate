...
public class DocIndexMetaData {
    ...
    private ReferenceInfo newInfo(ColumnIdent column,
                                  ...
                                  ReferenceInfo.IndexType indexType,
                                  boolean isNotNull) {
        return new ReferenceInfo(refIdent(column), granularity(column), type, columnPolicy, indexType, isNotNull);
    }
    ...
    private void internalExtractColumnDefinitions(@Nullable ColumnIdent columnIdent,
        ...
        for (Map.Entry<String, Object> columnEntry : propertiesMap.entrySet()) {
            ...
            boolean isNotNull = notNullColumns.contains(newIdent);
            ...
            if (columnDataType == DataTypes.GEO_SHAPE) {
                ...
                add(newIdent, columnDataType, columnPolicy, ReferenceInfo.IndexType.NO, false, isNotNull);
                ...
                if (indicesMap.containsKey(newIdent.fqn())) {
                    ...
                    add(newIdent, columnDataType, columnIndexType, isNotNull);
                }
            }
        }
    }
